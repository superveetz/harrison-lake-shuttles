...
const privacyPolicy = () => {
  ...
  return (
    <div className="container pb-3 pt-md-4">
      <PageHeader>Terms of Service / Privacy Policy</PageHeader>
      <p className="lead">Effective date: March 05, 2019</p>
      <p>
        Harrison Lake Shuttles ("us", "we", or "our") operates the http://harrisonlakeshuttles.com website (hereinafter
        referred to as the "Service").
      </p>
      <p>
        This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
        use our Service and the choices you have associated with that data. Our Privacy Policy for Harrison Lake
        Shuttles is created with the help of the Privacy Policies website.
      </p>
      <p>
      ...
      <h2>Use of Data</h2>
      <p>Harrison Lake Shuttles uses the collected data for various purposes:</p>
      <ul>
        ...
        <li>To perform reporting on transactional data</li>
      ...
      <p>
        ...
        data, including Personal Data, to Canada and process it there.
      </p>
      <p>
      ...
      <p>
        Harrison Lake Shuttles will take all steps reasonably necessary to ensure that your data is treated securely and
      ...
      <p>
        Harrison Lake Shuttles may disclose your Personal Data in the good faith belief that such action is necessary
        to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Harrison Lake Shuttles</li>
      ...
      <ul>
        <li>
          By email: <a href="mailto:info@harrisonlakeshuttles.com">info@harrisonlakeshuttles.com</a>
        </li>
      </ul>
    </div>
  );
